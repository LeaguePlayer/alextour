<?php
/**
 * Миграция m140415_055044_subscribes
 *
 * @property string $prefix
 */
 
class m140415_055044_subscribes extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{subscribes}}');
 
    public function safeUp()
    {
        $this->_checkTables();
 
        $this->createTable('{{subscribes}}', array(
