...
/**
* This is the model class for table "{{speciallist}}".
*
* The followings are the available columns in table '{{speciallist}}':
    * @property integer $id
...
*/
class Speciallist extends EActiveRecord
{
	...
	public function specialSearch($count = null)
    {
        $criteria = new CDbCriteria();
