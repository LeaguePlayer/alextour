...
$this->menu=array(
	array('label'=>"Добавить в {$model->node->name}", 'url'=>array('/admin/special/create', 'list_id'=>$model->id)),
...
<?php echo $this->renderPartial('_form',array('model'=>$model, 'specialFinder'=>$specialFinder)); ?>