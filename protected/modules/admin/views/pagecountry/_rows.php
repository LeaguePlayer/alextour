	<?php echo $form->textFieldControlGroup($model,'title',array('class'=>'span8')); ?>
	...
	<?php echo $form->dropDownListControlGroup($model, 'status', Pagecountry::getStatusAliases(), array('class'=>'span8', 'displaySize'=>1)); ?>
